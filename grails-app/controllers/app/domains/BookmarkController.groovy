...
//        redirect(action: "list", params: params)
    ...
    def list(Integer max) {
        ...
        render contentType: 'application/json', text: br.com.app.util.JsonUtils.toJson([success:true, total: instances.totalCount, data: instances])
    }
	...
	def save() {
        ...
        if (!bookmarkInstance.save(flush: true)) {
            model = [success: false, errors: br.com.app.util.JsonUtils.errorsToResponse(bookmarkInstance.errors, locale)]
        } else {
        ...
        render contentType: 'application/json', text: br.com.app.util.JsonUtils.toJson(model)
    }
    ...
    def update(Long id, Long version) {
        ...
        if (!bookmarkInstance) {
            String message = message(code: 'default.not.found.message', args: [message(code: 'bookmark.label', default: 'Bookmark'), id])
            render contentType: 'text/json', text: br.com.app.util.JsonUtils.toJson([success: false, message: message])
            return
        }
        ...
        if (version != null) {
            if (bookmarkInstance.version > version) {
                ...
                render contentType: 'text/json', text: br.com.app.util.JsonUtils.toJson([success: false, errors: bookmarkInstance.errors])
                return
            }
        }
        ...
        render contentType: 'application/json', text: br.com.app.util.JsonUtils.toJson([success: true, message: message])
    }
    ...
    def delete(Long id) {
		...
		render contentType: 'application/json', text: br.com.app.util.JsonUtils.toJson([success: success, message: message])
